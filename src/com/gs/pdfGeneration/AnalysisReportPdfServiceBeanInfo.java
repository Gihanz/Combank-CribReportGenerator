...
public class AnalysisReportPdfServiceBeanInfo extends SimpleBeanInfo {
	private final static Class beanClass = AnalysisReportPdfService.class;
	...
	public MethodDescriptor[] getMethodDescriptors() {
		try {
			...
			// public String generatePdf(int subjectType, String reportJson, boolean scoreRequired, String encryptionKey)
			method = beanClass.getMethod("generatePdf", java.lang.Integer.TYPE, String.class, java.lang.Boolean.TYPE, String.class);
			...
			// parm
			parm = new ParameterDescriptor();
			parm.setShortDescription("reportJson");
			parm.setDisplayName("reportJson");
			parmDescriptors.add(parm);
			// parm
			parm = new ParameterDescriptor();
